...
def extrude_along_path( shape_pts:Points, 
                        ...
                        convexity:int=10) -> OpenSCADObject:
    ...
    closed_path:bool = path_pts[0] == path_pts[len(path_pts) - 1]
    if closed_path:
        path_pts = path_pts[:-1]
    ...
    return polyhedron(points=euc_to_arr(polyhedron_pts), faces=facet_indices, convexity=convexity) # type: ignore
